 ...
 * @author USER
 */
public class f1_1 extends javax.swing.JFrame {
...
private  void x(){
 ...
 jLabel6.setText(String.valueOf(C.sold));
    ...
    try {
        ...
        Logger.getLogger(f1_1.class.getName()).log(Level.SEVERE, null, ex);
    }
...
File file = new File(Path_Getter.Get_One_ClientOrOneAccount_Path()+C.cin+"\\"+C.ID+"\\History.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f1_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
